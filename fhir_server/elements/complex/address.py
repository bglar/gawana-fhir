...
class Address(ComplexElement):
    ...
    def element_properties(self):
        ...
        elm.extend(
            [
                Field("city", {"mini": 0, "maxi": 1}, primitives.StringField, None),
                # Name of city, town etc..
                Field("country", {"mini": 0, "maxi": 1}, primitives.StringField, None),
                # Country (can be ISO 3166 3 letter code).
                Field("district", {"mini": 0, "maxi": 1}, primitives.StringField, None),
                # District name (aka county)
                Field("line", {"mini": 0, "maxi": -1}, primitives.StringField, None),
                # Street name, number, direction & P.O. Box etc..
                Field(
                    "postalCode", {"mini": 0, "maxi": 1}, primitives.StringField, None
                ),
                # Postal code for area.
                Field("state", {"mini": 0, "maxi": 1}, primitives.StringField, None),
                # Sub-unit of country (abbreviations ok).
                Field("type", {"mini": 0, "maxi": 1}, primitives.CodeField, None),
