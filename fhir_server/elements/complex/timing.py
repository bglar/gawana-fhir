...
class TimingRepeat(ComplexElement):
    ...
    def element_properties(self):
        ...
        elm.extend(
            [
                Field("count", {"mini": 0, "maxi": 1}, primitives.IntegerField, None),
                # Number of times to repeat.
                Field(
                    "duration", {"mini": 0, "maxi": 1}, primitives.DecimalField, None
                ),
                # How long when it happens.
                Field(
                    "durationMax", {"mini": 0, "maxi": 1}, primitives.DecimalField, None
                ),
                # How long when it happens (Max).
                Field(
                    "durationUnits", {"mini": 0, "maxi": 1}, primitives.CodeField, None
                ),
                # s | min | h | d | wk | mo | a - unit of time (UCUM).
                Field(
                    "frequency", {"mini": 0, "maxi": 1}, primitives.IntegerField, None
                ),
                ...
                Field("period", {"mini": 0, "maxi": 1}, primitives.DecimalField, None),
                # Event occurs frequency times per period.
                Field(
                    "periodMax", {"mini": 0, "maxi": 1}, primitives.DecimalField, None
                ),
                # Upper limit of period (3-4 hours).
                Field(
                    "periodUnits", {"mini": 0, "maxi": 1}, primitives.CodeField, None
                ),
                # s | min | h | d | wk | mo | a - unit of time (UCUM).
                ...
                Field("boundsQuantity", {"mini": 0, "maxi": 1}, DurationField(), None),
                # Length/Range of lengths, or (Start and/or end) limits.
...
class Timing(ComplexElement):
    ...
    def element_properties(self):
        ...
        elm.extend(
            [
                Field("event", {"mini": 0, "maxi": -1}, primitives.DateTimeField, None),
                # When the event occurs.
                Field("code", {"mini": 0, "maxi": 1}, CodeableConceptField(), None),
