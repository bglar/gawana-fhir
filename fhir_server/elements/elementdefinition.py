...
class ElementDefinitionBase(ComplexElement):
    ...
    def element_properties(self):
        ...
        elm.extend([
            Field('max', {'mini': 1, 'maxi': 1},
                  primitives.StringField, None),
            # Max cardinality of the base element.

            Field('min', {'mini': 1, 'maxi': 1},
                  primitives.IntegerField, None),
            # Min cardinality of the base element.

            Field('path', {'mini': 1, 'maxi': 1},
                  primitives.StringField, None),
...
class ElementDefinitionBinding(ComplexElement):
    ...
    def element_properties(self):
        elm = super().element_properties()
        elm.extend([
            Field('description', {'mini': 0, 'maxi': 1},
                  primitives.StringField, None),
            # Human explanation of the value set.

            Field('strength', {'mini': 1, 'maxi': 1},
                  primitives.CodeField, None),
            # required | extensible | preferred | example.

            Field('valueSetReference', {'mini': 0, 'maxi': 1},
                  complex.ReferenceField(), 'Valuesets'),
            # Source of value set.

            Field('valueSetUri', {'mini': 0, 'maxi': 1},
...
class ElementDefinitionConstraint(ComplexElement):
    ...
    def element_properties(self):
        elm = super().element_properties()
        elm.extend([
            Field('human', {'mini': 1, 'maxi': 1},
                  primitives.StringField, None),
            # Human description of constraint.

            Field('key', {'mini': 1, 'maxi': 1},
                  primitives.IdField, None),
            # Target of 'condition' reference above.

            Field('requirements', {'mini': 0, 'maxi': 1},
                  primitives.StringField, None),
...
class ElementDefinitionType(ComplexElement):
    ...
    def element_properties(self):
        elm = super().element_properties()
        elm.extend([
            Field('aggregation', {'mini': 0, 'maxi': -1},
                  primitives.CodeField, None),
...
class ElementDefinition(ComplexElement):
    ...
    def element_properties(self):
        ...
        elm.extend([
            ...
            Field('representation', {'mini': 0, 'maxi': -1},
                  primitives.CodeField, None),
            ...
            Field('label', {'mini': 0, 'maxi': 1},
                  primitives.StringField, None),
            # Name for element to display with or prompt for element.

            Field('short', {'mini': 0, 'maxi': 1},
                  primitives.StringField, None),
            ...
            Field('alias', {'mini': 0, 'maxi': -1},
                  primitives.StringField, None),
            # Other names.

            Field('min', {'mini': 0, 'maxi': 1},
                  primitives.IntegerField, None),
            # Minimum Cardinality.

            Field('max', {'mini': 0, 'maxi': 1},
                  primitives.StringField, None),
            # Maximum Cardinality (a number or *).

            Field('nameReference', {'mini': 0, 'maxi': 1},
                  primitives.StringField, None),
            # To another element constraint (by element.name).

            Field('meaningWhenMissing', {'mini': 0, 'maxi': 1},
                  primitives.MarkdownField, None),
            ...
            Field('condition', {'mini': 0, 'maxi': -1},
                  primitives.IdField, None),
            # Reference to invariant about presence.

            Field('mustSupport', {'mini': 0, 'maxi': 1},
                  primitives.BooleanField, None),
            # If the element must supported

            Field('isModifier', {'mini': 0, 'maxi': 1},
                  primitives.BooleanField, None),
            # If this modifies the meaning of other elements.

            Field('isSummary', {'mini': 0, 'maxi': 1},
                  primitives.BooleanField, None),
            # Include when _summary = true?.

            Field('defaultValue', {'mini': 0, 'maxi': 1},
                  OpenType, None),
            # Specified value it missing from instance

            Field('fixed', {'mini': 0, 'maxi': 1},
                  OpenType, None),
            # Value must be exactly this

            Field('pattern', {'mini': 0, 'maxi': 1},
                  OpenType, None),
            # Value must have at least these property values

            Field('example', {'mini': 0, 'maxi': 1},
                  OpenType, None),
            # Example value: [as defined for type]

            Field('minValue', {'mini': 0, 'maxi': 1},
                  OpenType, None),
            # Minimum Allowed Value (for some types)

            Field('maxValue', {'mini': 0, 'maxi': 1},
                  OpenType, None),
            ...
            Field('slicing', {'mini': 0, 'maxi': 1},
                  ElementDefinitionSlicingField(), None),
            # This element is sliced - slices follow.

            Field('base', {'mini': 0, 'maxi': 1},
            ...
            Field('constraint', {'mini': 0, 'maxi': -1},
                  ElementDefinitionConstraintField(), None),
            # Condition that must evaluate to true.

            Field('binding', {'mini': 0, 'maxi': 1},
                  ElementDefinitionBindingField(), None),
            # ValueSet details if this is coded.

            Field('mapping', {'mini': 0, 'maxi': -1},
                  ElementDefinitionMappingField(), None),
            # Map element to another set of definitions.
        ])
        return elm
