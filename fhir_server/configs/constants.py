...
VALID_XML_MIMETYPES = ["xml", "text/xml", "application/xml", "application/xml+fhir"]

VALID_JSON_MIMETYPES = ["json", "application/json", "application/json+fhir"]
...
SERVICE_DELIVERY_LOCATION_ROLE_TYPE_URL = VALUESETS_BASE_URL + "RoleCode/"
...
SERVICE_PROVISION_CONDITIONS_URL = VALUESETS_BASE_URL + "service_provision_conditions/"
...
PATIENT_CONTACT_RELATIONSHIP_URL = VALUESETS_BASE_URL + "patient_contact_relationship/"
...
SIGNATURE_MIME_TYPES = ["application/jwt", "image/jpeg"]
