...
from fhir_server.utils import (
    ElementSerializer, CRUDMixin, Versioned, versioned_session)
...
class Resource(CRUDMixin, ElementSerializer, Versioned, BaseOperations,
               db.Model):
    """ Base Resource.
    ...
    id = Column(primitives.IdField, default=lambda: uuid.uuid4().__str__(),
                primary_key=True)
    ...
    updated_at = Column(primitives.InstantField, default=str_now,
                        onupdate=str_now)
