...
from fhir_server.elements import ComplexElement, Field, primitives, complex
...
class ValueSetCodeSystemConceptDesignation(ComplexElement):
    ...
    def element_properties(self):
        ...
        elm.extend(
            [
                Field("language", {"mini": 0, "maxi": 1}, primitives.StringField, None),
                # Human language of the designation.
                Field("value", {"mini": 1, "maxi": 1}, primitives.StringField, None),
                # The text value for this designation.
                Field("use", {"mini": 0, "maxi": 1}, complex.CodingField(), None)
...
ValueSetCodeSystemConceptDesignationField = ValueSetCodeSystemConceptDesignation()
    ...
    def element_properties(self):
        ...
        elm.extend(
            [
                ...
                Field(
                    "abstract", {"mini": 0, "maxi": 1}, primitives.BooleanField, None
                ),
                # If this code is not for use as a real concept.
                Field("display", {"mini": 0, "maxi": 1}, primitives.StringField, None),
                # Text to display to the user.
                Field(
                    "definition", {"mini": 0, "maxi": 1}, primitives.StringField, None
                ),
                # Formal definition.
                Field(
                    "concept", {"mini": 0, "maxi": -1}, primitives.StringField, "Self"
                ),
...
class ValueSetCodeSystem(ComplexElement):
    ...
    def element_properties(self):
        ...
        elm.extend(
            [
                Field("system", {"mini": 1, "maxi": 1}, primitives.URIField, None),
...
class ValueSetComposeIncludeFilter(ComplexElement):
    ...
    def element_properties(self):
        ...
        elm.extend(
            [
                Field("op", {"mini": 1, "maxi": 1}, primitives.CodeField, None),
                # = | is-a | is-not-a | regex | in | not-in.
                Field("property", {"mini": 1, "maxi": 1}, primitives.CodeField, None),
                # A property defined by the code system.
                Field("value", {"mini": 1, "maxi": 1}, primitives.CodeField, None)
...
class ValueSetComposeInclude(ComplexElement):
    ...
    def element_properties(self):
        ...
        elm.extend(
            [
                Field("system", {"mini": 1, "maxi": 1}, primitives.CodeField, None),
                # The system the codes come from.
                Field("version", {"mini": 0, "maxi": 1}, primitives.CodeField, None),
...
class ValueSetCompose(ComplexElement):
    ...
    def element_properties(self):
        ...
        elm.extend(
            [
                Field(
                    "compose_import", {"mini": 0, "maxi": -1}, primitives.URIField, None
                ),
    ...
    def element_properties(self):
        ...
        elm.extend(
            [
                ...
                Field(
                    "contains", {"mini": 0, "maxi": -1}, primitives.StringField, "Self"
                )
...
class ValueSetExpansionParameter(ComplexElement):
    ...
    def element_properties(self):
        ...
        elm.extend(
            [
                Field("name", {"mini": 1, "maxi": 1}, primitives.StringField, None),
                ...
                Field("valueCode", {"mini": 0, "maxi": 1}, primitives.CodeField, None),
                # Value of the named parameter.
                Field(
                    "valueDecimal",
                    {"mini": 0, "maxi": 1},
                ...
                # Value of the named parameter.
                Field(
                    "valueString", {"mini": 0, "maxi": 1}, primitives.StringField, None
                ),
                # Value of the named parameter.
                Field("valueUri", {"mini": 0, "maxi": 1}, primitives.URIField, None),
                # Value of the named parameter.
            ]
        )
        return elm
...
class ValueSetExpansion(ComplexElement):
    ...
    def element_properties(self):
        ...
        elm.extend(
            [
                Field("identifier", {"mini": 1, "maxi": 1}, primitives.URIField, None),
                # Uniquely identifies this expansion.
                Field(
                    "timestamp", {"mini": 1, "maxi": 1}, primitives.DateTimeField, None
                ),
                # Time ValueSet expansion happened.
                Field("offset", {"mini": 0, "maxi": 1}, primitives.IntegerField, None),
                # Offset at which this resource starts.
                Field("total", {"mini": 0, "maxi": 1}, primitives.IntegerField, None),
