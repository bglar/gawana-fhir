...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "active", fhir_server.elements.primitives.BooleanField(), nullable=True
        ),
                        ...
                        Column(
                            ...
                            PgComposite(
                                ...
                                [
                                    ...
                                    Column("id", StringField()),
                                    Column("family", CompositeArray(StringField())),
                                    Column("given", CompositeArray(StringField())),
                                    Column("prefix", CompositeArray(StringField())),
                                    Column("suffix", CompositeArray(StringField())),
                                    Column("text", StringField()),
                                    Column("use", CodeField()),
                                    Column(
                                        "period",
