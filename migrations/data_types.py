from fhir_server.resources.structuredefinition import (
    StructureDefinitionContactField,
    StructureDefinitionSnapshotField,
    StructureDefinitionMappingField,
    StructureDefinitionDifferentialField,
)
...
from fhir_server.resources.identification.healthcareservice import (
    HealthcareServiceAvailableTimeField,
    HealthcareServiceNotAvailableField,
)
from fhir_server.resources.identification.location import LocationPositionField
from fhir_server.resources.identification.organization import OrganizationContactField
...
from fhir_server.resources.identification.practitioner import (
    PractitionerPractitionerRoleField,
    PractitionerQualificationField,
)
...
Fields = {
    ...
    "valuesetcodesystemconceptdesignation": ValueSetCodeSystemConceptDesignationField,
