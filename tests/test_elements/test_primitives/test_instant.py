...
class TestInstantField(object):
    def test_time_no_timezone(self):
        ...
        assert ('The Instant 2011-05-24T22:00:02 is invalid') in str(
            excinfo.value)
    ...
    def test_time_no_seconds(self):
        ...
        assert ('The Instant 2011-05-24T22:00 is invalid') in str(
            excinfo.value)
    ...
    def test_2400_hrs(self):
        ...
        assert ('The Instant 2011-05-24T24:00:00 is invalid') in str(
            excinfo.value)
    ...
    def test_seconds_prefilled(self, session, TestDataTypesModel):
        ...
        post_data = TestDataTypesModel(
            id=id,
            instant_field='2011-05-24T22:25+0300'
        )
        session.add(post_data)
        session.commit()
