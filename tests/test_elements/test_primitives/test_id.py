...
class TestIdField(object):
    def test_valid_id(self):
        result = primitives.IdField().process_bind_param("aa3-g26-k2l-nm3", "postgres")
    ...
    def test_empty_string_id(self):
        ...
        assert "Id must have at least 1 character" in str(excinfo.value)
    ...
    def test_id_more_than_64_chars(self):
        ...
        assert "Id field cannot be more than 64 characters" in str(excinfo.value)
    ...
    def test_IdField_value_invalid(self, session, TestDataTypesModel):
        post_data = TestDataTypesModel(id=":::", int_field=1)
